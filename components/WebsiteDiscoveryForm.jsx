      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8 md:p-12 space-y-10">
          ...
          <div className="pt-6">
            <button
              type="submit"
              className="w-full bg-linear-to-r from-teal-600 to-cyan-600 text-white font-semibold py-4 px-8 rounded-lg hover:from-teal-700 hover:to-cyan-700 transform hover:-translate-y-0.5 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2"
            >
