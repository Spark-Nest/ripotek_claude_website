...
import { Menu, X, ChevronDown, Briefcase, MapPin, DollarSign, Clock, Users, CheckCircle, Target, Award, Heart, TrendingUp, Mail, Calendar, BookOpen, Phone, ArrowLeft } from 'lucide-react';
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <Clock className="w-6 h-6 text-teal-600 mt-1 shrink-0" />
                <div>
