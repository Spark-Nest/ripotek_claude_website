  ...
  <p className="text-white text-[8px] md:text-[10px] italic font-normal leading-none mt-0.5 text-center">Design. Engineer. Deliver.</p>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="border-l-4 border-indigo-600 pl-4">
              ...
              <p className="text-gray-700">CAD $1,000</p>
        ...
        <footer className="border-t-4 border-indigo-600 pt-8 mt-12">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div><h4 className="font-bold text-gray-900 mb-3 flex items-center gap-2"><Phone className="w-5 h-5 text-indigo-600" />Phone</h4><p className="text-gray-700 text-sm">+1 587 259-0033</p></div>
