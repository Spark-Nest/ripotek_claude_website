      ...
      <div className="max-w-5xl mx-auto p-8 print:p-12">
        ...
        <footer className="border-t-4 border-indigo-600 pt-8 mt-12">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div><h4 className="font-bold text-gray-900 mb-3 flex items-center gap-2"><Phone className="w-5 h-5 text-indigo-600" />Phone</h4><p className="text-gray-700 text-sm">+1 (403) 999-RIPO</p></div>
