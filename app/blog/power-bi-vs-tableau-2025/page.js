...
import { Menu, X, ChevronDown, ArrowLeft, Calendar, Clock, User, Linkedin, Twitter, Mail, ChevronRight, CheckCircle, BarChart3, TrendingUp, DollarSign } from 'lucide-react';
...
export default function BlogPost() {
  ...
  const postMeta = {
    ...
    authorBio: 'David Thompson has deployed both Power BI and Tableau solutions for 30+ enterprises. He specializes in helping organizations choose and implement the right BI stack for their needs, with expertise in data visualization, semantic modeling, and enterprise BI governance.',
            ...
            <aside className="lg:col-span-4 space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-teal-600 to-blue-900 rounded-full flex items-center justify-center text-white text-2xl font-bold">DT</div>
                  <div>
              ...
              <div className="bg-gradient-to-br from-blue-900 to-teal-900 rounded-2xl shadow-lg p-6 text-white">
                <h3 className="text-xl font-bold mb-3">Learn Power BI</h3>
                <p className="text-gray-200 mb-4 text-sm">12-week program. Build 5 dashboards. Get PL-300 certified.</p>
