...
import { Menu, X, ChevronDown, Search, Calendar, Clock, User, ArrowRight, Filter } from 'lucide-react';
...
export default function BlogPage() {
  ...
  const categories = ['All', 'Azure', 'Career', 'Best Practices', 'Tools', 'Business Intelligence'];
