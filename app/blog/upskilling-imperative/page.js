...
import { Menu, X, ChevronDown, ArrowLeft, Calendar, Clock, User, Share2, Linkedin, Twitter, Mail, ChevronRight, CheckCircle, TrendingUp, Target, Award } from 'lucide-react';
...
export default function BlogPost() {
  ...
  const postMeta = {
    ...
    authorBio: 'Marcus Johnson leads Ripotek\'s training programs, helping professionals transition into data careers. With a background in adult education and data engineering, he has trained over 1,500 students, 85% of whom secured data roles within 90 days.',
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            <aside className="lg:col-span-4 space-y-8">
              ...
              <div className="bg-gradient-to-br from-blue-900 to-teal-900 rounded-2xl shadow-lg p-6 text-white">
                <h3 className="text-xl font-bold mb-3">Start Your Data Career</h3>
                <p className="text-gray-200 mb-4 text-sm">
                  85% of our graduates land roles within 90 days. Join the next cohort.
                </p>
