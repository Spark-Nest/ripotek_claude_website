        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-12 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-300 text-base leading-relaxed max-w-xl mt-4">Enterprise data consulting and training services. Empowering organizations with governed self-service BI, Azure modernization, and industry-leading expertise.</p>
              <div className="mt-6 space-y-3 text-gray-300 text-base">
                <div className="flex items-center gap-3">Calgary, Alberta, Canada</div>
                <div className="flex items-center gap-3">info@ripotek.com</div>
                <div className="flex items-center gap-3">+1 306-999-3552</div>
              </div>
